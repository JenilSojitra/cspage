...
(function ($) {
    ...
    // // svg fallback
    // if (!Modernizr.svg) {
    //     $(".home-main-logo img").attr("src", "images/logo.png");
    // }
    ...
    var ssPreloader = function () {
        ...
        $WIN.on('load', function () {
            ...
            $("#homeloader").fadeOut("slow", function () {
                // will fade out the whole DIV that covers the website.
                $("#homepreloader").delay(300).fadeOut("slow");
            });
    ...
    var ssInfoToggle = function () {
        ...
        $('.info-toggle-menu').on('click', function (event) {
    ...
    var ssFinalCountdown = function () {
        ...
        $('.home-main-content__clock').countdown(finalDate)
